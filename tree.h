...
void tree_delete(tree_root_t *tree, tree_action cleanup);

/// Get the size of the tree
///
/// \returns: the number of nodes in the tree
int tree_size(tree_root_t *tree);

/// Get the depth of the tree
///
/// \returns: the depth of the deepest subtree
int tree_depth(tree_root_t *tree);
...
bool tree_insert(tree_root_t *tree, K key, T elem);
...
bool tree_has_key(tree_root_t *tree, K key);
...
T tree_get(tree_root_t *tree, K key);
